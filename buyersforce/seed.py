...
def run():
    ...
    def user(role, name, email, company, title=""):
        cur.execute(
            "INSERT INTO users (role, name, email, password_hash, company, title) "
            "VALUES (?, ?, ?, ?, ?, ?)",
            (role, name, email, PW, company, title),
        )
    ...
    print("Demo buyer login: dana@meridianhealth.com / demo1234")
    print("Demo seller login: sam@aegisshield.io / demo1234")
